...
#TODO - Complete the cancel Button.

def cancel():
    tmsg.askquestion("Cancel Registration", "If You Cancel Registration then you will lose the Data you Entered")
    if tmsg.askquestion=='yes':
        return exit
...
def values():
    ...
    # with open("C:\\Users\\91762\\Desktop\\VS Code\\Projects\\RegistrationForm\\Form.txt","a") as f:
...
root.minsize(850,799)
root.maxsize(850,799)
...
photo=PhotoImage(file="C:\\Users\\91762\\Desktop\\VS Code\\Projects\\RegistrationForm\\wolf.png")
...
Button(text="Exit",font="comicsansms 19 bold",command=quit).grid(row=1205,column=105)

Button(text="Cancel\nRegistration",font="comicsansms 15 bold",command=cancel).grid(row=1205,column=100)
